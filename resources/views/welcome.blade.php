...
<section class="relative isolate min-h-[760px] overflow-hidden bg-slate-950">
    ...
    <div class="absolute inset-0 -z-20">
        ...
        <img
            src="https://images.unsplash.com/photo-1558981806-ec527fa84c39?auto=format&fit=crop&w=2400&q=85"
            alt="Motorcykel på en väg"
...
<section
    id="resor"
    class="bg-slate-50 py-24 sm:py-32"
>
            ...
            <div class="space-y-8">
                ...
                <article class="relative grid gap-6 md:grid-cols-[120px_1fr] md:gap-12">
                    ...
                    <div class="hidden pt-8 text-right md:block">
                        ...
                        <div class="mt-2">
                            <span class="rounded-full bg-orange-500 px-3 py-1 text-[10px] font-black uppercase tracking-wide text-white">
                                Senaste
                            </span>
                        </div>
                    ...
                    {{-- Card --}}
                    <article class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl">
                        ...
                        <div class="grid md:grid-cols-2">
                            ...
                            <div class="group overflow-hidden">
                                ...
                                <img
                                    src="https://images.unsplash.com/photo-1525160354320-d8e92641c563?auto=format&fit=crop&w=1200&q=85"
                            ...
                            <div class="p-7 sm:p-9">
                                ...
                                <div class="mb-4 flex items-center gap-3 md:hidden">
                                    ...
                                    <span class="rounded-full bg-orange-100 px-2.5 py-1 text-[10px] font-black uppercase text-orange-600">
                                        Senaste
                                    </span>
                    ...
                    <article class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl">
                        ...
                        <div class="grid md:grid-cols-2">
                            ...
                            <div class="group overflow-hidden">
                                ...
                                <img
                                    src="https://images.unsplash.com/photo-1558980664-10ea9b7e44d3?auto=format&fit=crop&w=1200&q=85"
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
            ...
            <div class="overflow-hidden rounded-2xl">
                ...
                <img
                    src="https://images.unsplash.com/photo-1558981285-6f0c94958bb6?auto=format&fit=crop&w=1400&q=85"
                    alt="Motorcykel på väg"
...
<section
    id="utrustning"
    class="bg-slate-100 py-24 sm:py-32"
>
...
<section
    id="kontakt"
    class="relative overflow-hidden bg-slate-950 py-24 sm:py-32"
>
