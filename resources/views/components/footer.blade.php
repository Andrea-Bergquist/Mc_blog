...
<footer class="bg-slate-950 text-white">
    <div class="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        ...
        <div class="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
                ...
                <ul class="mt-5 space-y-3 text-sm">
                    <li>
                        <a href="/" class="text-slate-400 transition hover:text-orange-400">
                            Hem
                        </a>
                    </li>

                    <li>
                        <a href="#resor" class="text-slate-400 transition hover:text-orange-400">
                            Resor
                        </a>
                    </li>

                    <li>
                        <a href="#om-mig" class="text-slate-400 transition hover:text-orange-400">
                            Om mig
                        </a>
                    </li>

                    <li>
                        <a href="#utrustning" class="text-slate-400 transition hover:text-orange-400">
                            Utrustning
                        </a>
                    </li>

                    <li>
                        <a href="#kontakt" class="text-slate-400 transition hover:text-orange-400">
                            Kontakt
                        </a>
                    </li>
                </ul>
        ...
        <div class="mt-16 border-t border-slate-800 pt-8 text-center text-sm text-slate-500">
            © {{ date('Y') }} Mc Blogg. Alla rättigheter förbehållna.
        </div>
